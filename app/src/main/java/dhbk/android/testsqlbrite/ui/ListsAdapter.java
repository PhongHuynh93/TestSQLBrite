...
// remember adapter with action1 interface
final class ListsAdapter extends BaseAdapter implements Action1<List<ListsItem>> {
    ...
    /**
     * method in action1 need to be override, this method was called when it's the time to emit the data, so notifyDataSetChanged
     * @param items
     */
    @Override
